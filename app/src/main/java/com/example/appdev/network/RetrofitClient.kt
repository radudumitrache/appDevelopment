...
object RetrofitClient {
    ...
    private val retrofitExchange: Retrofit = Retrofit.Builder().baseUrl(BASE_URL_EXCHANGE)
        .addConverterFactory(GsonConverterFactory.create()).build()

    private val retrofitNominatim: Retrofit = Retrofit.Builder().baseUrl(BASE_URL_NOMINATIM)
        .addConverterFactory(GsonConverterFactory.create()).build()
